module.exports = {
	...
	redis.hmset("club:"+club.id, "club_config_id", club.club_config_id, "name",club.name, "entry_fees", club.entry_fees, "winner_amount", club.winner_amount, "club_type",  clubType);
	},
